...
exports.builtInReporters = exports.Runner = exports.kDefaultConfigFiles = void 0;
...
class Runner {
  constructor(configOverrides, options = {}) {
    this._loader = void 0;
    this._printResolvedConfig = void 0;
  ...
  async loadConfigFromFile(configFileOrDirectory) {
    const loadConfig = async configFile => {
      if (fs.existsSync(configFile)) {
        if (this._printResolvedConfig) console.log(`Using config at ` + configFile);
  ...
  async runAllTests(options = {}) {
    ...
    try {
      ...
      const result = await (0, _async.raceAgainstDeadline)(this._run(!!options.listOnly, options.filePatternFilter || [], options.projectFilter), globalDeadline);

      if (result.timedOut) {
        var _this$_reporter$onEnd, _this$_reporter, _this$_reporter$onErr, _this$_reporter2;

        const actualResult = {
          status: 'timedout'
        };
        if (this._didBegin) await ((_this$_reporter$onEnd = (_this$_reporter = this._reporter).onEnd) === null || _this$_reporter$onEnd === void 0 ? void 0 : _this$_reporter$onEnd.call(_this$_reporter, actualResult));else (_this$_reporter$onErr = (_this$_reporter2 = this._reporter).onError) === null || _this$_reporter$onErr === void 0 ? void 0 : _this$_reporter$onErr.call(_this$_reporter2, createStacklessError(`Timed out waiting ${config.globalTimeout / 1000}s for the entire test run`));
        return actualResult;
      }
      ...
      try {
        var _this$_reporter$onErr2, _this$_reporter3;

        (_this$_reporter$onErr2 = (_this$_reporter3 = this._reporter).onError) === null || _this$_reporter$onErr2 === void 0 ? void 0 : _this$_reporter$onErr2.call(_this$_reporter3, (0, _util2.serializeError)(e));
      } catch (ignored) {}
  ...
  async _run(list, testFileReFilters, projectNames) {
    ...
    try {
      var _this$_reporter$onBeg, _this$_reporter7, _this$_reporter$onEnd3, _this$_reporter9;

      const preprocessRoot = new _test.Suite('');

      for (const file of allTestFiles) preprocessRoot._addSuite(await this._loader.loadTestFile(file));

      if (config.forbidOnly) {
        const onlyTestsAndSuites = preprocessRoot._getOnlyItems();

        if (onlyTestsAndSuites.length > 0) {
          var _this$_reporter$onErr3, _this$_reporter4;

          (_this$_reporter$onErr3 = (_this$_reporter4 = this._reporter).onError) === null || _this$_reporter$onErr3 === void 0 ? void 0 : _this$_reporter$onErr3.call(_this$_reporter4, createForbidOnlyError(config, onlyTestsAndSuites));
          return {
            status: 'failed'
          };
        }
      ...
      if (clashingTests.size > 0) {
        var _this$_reporter$onErr4, _this$_reporter5;

        (_this$_reporter$onErr4 = (_this$_reporter5 = this._reporter).onError) === null || _this$_reporter$onErr4 === void 0 ? void 0 : _this$_reporter$onErr4.call(_this$_reporter5, createDuplicateTitlesError(config, clashingTests));
        return {
          status: 'failed'
        };
      }
      ...
      if (!total) {
        var _this$_reporter$onErr5, _this$_reporter6;

        (_this$_reporter$onErr5 = (_this$_reporter6 = this._reporter).onError) === null || _this$_reporter$onErr5 === void 0 ? void 0 : _this$_reporter$onErr5.call(_this$_reporter6, createNoTestsError());
        return {
          status: 'failed'
        };
      }
      ...
      (_this$_reporter$onBeg = (_this$_reporter7 = this._reporter).onBegin) === null || _this$_reporter$onBeg === void 0 ? void 0 : _this$_reporter$onBeg.call(_this$_reporter7, config, rootSuite);
      this._didBegin = true;
      ...
      if (sigint) {
        var _this$_reporter$onEnd2, _this$_reporter8;

        const result = {
          status: 'interrupted'
        };
        await ((_this$_reporter$onEnd2 = (_this$_reporter8 = this._reporter).onEnd) === null || _this$_reporter$onEnd2 === void 0 ? void 0 : _this$_reporter$onEnd2.call(_this$_reporter8, result));
        return result;
      }
      ...
      await ((_this$_reporter$onEnd3 = (_this$_reporter9 = this._reporter).onEnd) === null || _this$_reporter$onEnd3 === void 0 ? void 0 : _this$_reporter$onEnd3.call(_this$_reporter9, result));
      return result;
    } finally {
